...
setup( name = "whoispy",
    version = "0.2.2",
    py_modules = ["whoispy", "whoisSrvDict", "parser_branch", "parser_base", "parser_whoisVerisignGrsCom", "parser_whoisEnomCom", "parser_whoisGodaddyCom", "parser_whoisUniregistrarCom", "parser_whois2016JprsJp"],
    license = "GPL License",
